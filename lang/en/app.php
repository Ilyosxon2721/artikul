...
return [
    ...
    'two_factor' => [
        ...
        'subtitle' => 'Protect your account with a TOTP app (Google Authenticator, Authy, 1Password).',
        'start' => 'Enable 2FA',
        'start_hint' => "We'll generate a secret — scan it in your authenticator app and confirm with a 6-digit code.",
        'scan_qr' => 'Open your authenticator app and scan the URL below:',
        'manual_secret' => 'Or enter manually',
        'code_label' => 'App code',
        'confirm' => 'Confirm and enable',
        'enabled' => 'Two-factor authentication enabled.',
        'is_enabled' => '2FA is enabled.',
        'disable' => 'Disable 2FA',
        'disable_password' => 'Current password',
        'disabled' => '2FA disabled.',
        'invalid_code' => 'Invalid code.',
        'recovery_title' => 'Recovery codes',
        'recovery_hint' => 'Store these codes in a safe place. Each one is single-use.',
        'challenge_title' => 'Enter your 2FA code',
        'enter_code' => 'Open your authenticator app and enter the 6-digit code.',
        'use_recovery' => 'Enter one of your recovery codes.',
        'use_recovery_code' => 'Use a recovery code',
        'use_app_code' => 'Use an app code',
    ...
    'password_rotation' => [
        ...
        'subtitle' => "It's been more than 180 days since your last password change. Set a new password to keep using the admin panel.",
    ...
    'telegram' => [
        ...
        'apply_task_unavailable' => 'This task is no longer accepting proposals.',
        'apply_intro' => 'Applying to "{title}". Send /cancel to stop.',
        'apply_ask_amount' => '1/3 — what price are you offering? (number only, in the task currency)',
        'apply_amount_invalid' => 'Please enter a number greater than zero.',
        'apply_ask_days' => '2/3 — how many days will it take?',
        'apply_days_invalid' => 'Enter an integer between 1 and 365.',
        'apply_ask_cover' => '3/3 — write a short cover letter (min 30 characters).',
        'apply_cover_invalid' => 'Too short — minimum 30 characters.',
        'apply_done' => '✅ Proposal sent on "{title}".',
        'apply_failed' => "Couldn't submit the proposal. Try again later.",
        'apply_error' => '❌ :error',
    ],
