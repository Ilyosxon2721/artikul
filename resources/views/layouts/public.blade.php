...
<head>
    ...
    <title>{{ $title ?? __('app.tagline') }} — Artikul</title>
    <meta name="description" content="{{ $meta_description ?? __('app.tagline') }}">

    <meta property="og:type" content="website">
    <meta property="og:title" content="{{ $title ?? 'Artikul' }}">
    <meta property="og:description" content="{{ $meta_description ?? __('app.tagline') }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
            ...
            <div>
                ...
                <ul class="space-y-1 text-gray-500">
                    ...
                    <li><a href="{{ url('/how-it-works') }}" class="hover:text-gray-800">{{ __('app.nav.how_it_works') }}</a></li>
                </ul>
            </div>
            <div>
